...
function Register() {
    ...
    const onSubmit = async (data) => {
        const { fullName, email, phoneNumber, agentNumber, affiliation, gender, city } = data; // ดึงข้อมูลจากฟอร์ม

        const emailData = {
            service_id: 'service_dhma91y',
            template_id: 'template_sjsmono',
            user_id: 'DfB3LkE-ArB0N_5Mc',
            template_params: {
                to_email: email, // ใช้ที่อยู่อีเมลที่ผู้ใช้กรอกในฟอร์ม
                from_name: fullName,
                message: `
                    ข้อมูลการลงทะเบียน:
